...
public class UploadTutorialBean {
	...
	public boolean doReplaceFilePost(HttpServletRequest request, ServletContext context) {
		...
		try {
			...
			setErro("Uma Exce��o ocorreu: " + e.getMessage());
			e.printStackTrace();
			return false;
		}
	...
	@SuppressWarnings("rawtypes")
	public boolean doNewFilePost(HttpServletRequest request, ServletContext context) {
		if (request.getContentType() == null) {
			return false;
		}
